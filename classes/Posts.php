...
class Posts
{
    ...
    public function addPost($title, $description, $image, $user_name, $category) {
        ...
        try {
            ...
            $statement->execute([":title" => $title, ":description" => $description, ":created_by" => $user_name, ":image" => $image, ":category_id" => $category]);
